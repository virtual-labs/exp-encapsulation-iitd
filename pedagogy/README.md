...
<b> Experiment|  <b> 1. Introduction to Package
...
#### Experimentation
The lab will focus on the process of develop java programming code including the syntax and methods used for creating and importing package in java programs.
#### Learn from failure
...
:--|:--|:--|:-:
1.| Student will be able to: <br>describe the structure of package using java<br> | Understand| Describe
...
:--|:--|:--|:--
1.| Student will be able to describe the structure of package using java. | Select the text editor for your java program. | Q • Which of the following package stores all the standard java classes? <br>a) lang<br><b>b) java</b><br>c) util<br>d) java.packages
2.| Student will be able to identify different components of a java program.| Demonstrate the working of creating and importing package in program. | Q • Which of these keywords is used to define packages in Java?<br>a) pkg<br><b>b) package</b>
3.| Student will be able to develop a basic java program to display any text.| Construct a java program for displaying given output. | Q • Which of these is a mechanism for naming and visibility control of a class and its content? <br>a) Object<br><b>b) Packages</b><br>c) Interfaces<br>d) None of these
